...
window.VIM_YEARS["2026"] = {
  ...
  /* ---------- SPONSORS DECK  (the green spark, top-right of every page) ----------
     ...
     logo → their visiting card. Order here = order in the deck.
       ...
       card – visiting-card image (landscape). "" shows a "coming soon" card.
  ...
  sponsors: [
    { name: "Dr. M.A. Mejalla MDS, Dental Surgeon", logo: "assets/img/2026/sponsors/sponsor-01.png", card: "assets/img/2026/sponsors/sponsor-01-card.jpg", url: "https://www.drmdentistry.com/" }
  ],
  ...
  luckyDraw: {
    /* Switched OFF for 2026 — not going ahead. draw.html and stage.html
       redirect home, the nav/home/footer links are gone and the staff
       desk hides its ticket tab. The code is kept for a future year. */
    enabled: false,
  ...
  venueMap: {
    ...
    zones: [
      ...
      { id: "center",   label: { en: "Center of Attraction", ta: "முக்கிய கவர்ச்சி மையம்" }, venue: "Center of Attraction",
        blurb: { en: "The main stage and the open games area, live through the day.",
                 ta: "முக்கிய மேடை மற்றும் திறந்த விளையாட்டு பகுதி, நாள் முழுவதும் நேரடி நிகழ்ச்சிகள்." } },
